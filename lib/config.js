...
export function parseConfig(config) {
  const parsed = {
    ...
    filterHoldingBids: config.filter_holding_bids !== undefined ? config.filter_holding_bids : false,
    holdingBidThreshold: config.holding_bid_threshold !== undefined ? config.holding_bid_threshold : 0.01,
    holdingBidAgeHours: config.holding_bid_age_hours !== undefined ? config.holding_bid_age_hours : 24
  };
