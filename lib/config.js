...
export function parseConfig(config) {
  const parsed = {
    ...
    holdingItemThresholdAsk: config.holding_item_threshold_ask !== undefined ? config.holding_item_threshold_ask : 9999,
    holdingItemMultiplier: config.holding_item_multiplier !== undefined ? config.holding_item_multiplier : 10,
    holdingItemAgeHours: config.holding_item_age_hours !== undefined ? config.holding_item_age_hours : 24
  };
