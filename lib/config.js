...
export function parseConfig(config) {
  const parsed = {
    ...
    // Unified holding item configuration
    filterHoldingItems: config.filter_holding_items !== undefined ? config.filter_holding_items : false,
    holdingItemThresholdBid: config.holding_item_threshold_bid !== undefined ? config.holding_item_threshold_bid : 0.01,
    holdingItemMultiplier: config.holding_item_multiplier !== undefined ? config.holding_item_multiplier : 10,
    holdingItemAgeHoursBid: config.holding_item_age_hours_bid !== undefined ? config.holding_item_age_hours_bid : 24,
    holdingItemAgeHoursAsk: config.holding_item_age_hours_ask !== undefined ? config.holding_item_age_hours_ask : 336
  };
